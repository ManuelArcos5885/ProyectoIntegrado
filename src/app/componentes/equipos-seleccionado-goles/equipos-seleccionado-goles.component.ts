...
@Component({
  selector: 'equipoSeleccionadoGoles',
  templateUrl: './equipos-seleccionado-goles.component.html',
  styleUrl: './equipos-seleccionado-goles.component.css'
})
export class EquiposSeleccionadoGolesComponent implements OnInit{
  ...
  openModal(equipo: Equipo): void {
    ...
    const modal = document.getElementById('editarGolModal');
    if (modal) {
